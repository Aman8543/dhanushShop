...
import { loginUser } from "../redux/slice1" ;
...
function Login(){
 ...
 <form 
  ...
  className="card flex-shrink-0 w-100 max-w-sm shadow-2xl bg-base-100 m-auto "
>
  <div className="card-body">
    ...
    <div className="form-control">
      ...
      />
      {errors.phone && (
        <span className="text-error label-text-alt">{errors.phone.message}</span>
      )}
    </div>
